...
if (isset($_POST['order'])){
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        $spare_pic = time() . basename($_FILES["fileToUpload"]["name"]);
    ...
    //  }else{
    //     header('location:shop-spare.php');
    // }
    header('location:shop-spare.php');
      /* insert into   */ 
    $sql="INSERT INTO Spare_Parts (seller_name,seller_phone,amount,status,description,price,brand,model,image) VALUES ('$seller_name','$seller_phone','$amount', '$status', '$description', '$price','$brand','$model','$spare_pic') ";
...
<h2>Set Your Spare Parts Information here..</h2>
<br>
...
<div class="container">
 ...
 echo $model_error;} ?>
   ...
   <label for="fileToUpload" class="form-label">Picture of Spare Part</label>
