...
<section id="butn">
  ...
  <div class="row">
    <div class="col-sm-4">
        <h1>GET WINCH NOW <span style="color: #ff6d00;">FOR YOUR CAR</span> </h1>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-3"><a class="btn btn-success" href="winch-order.php" style="color:white;">Get Winch</a>
  </div>
    <div class="col-sm-3"><a class="btn btn-success" href="mech-order.php" style="color:white;">Get Mechanical</a>
  </div>
