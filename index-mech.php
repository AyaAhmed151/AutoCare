...
<section id="butn">
  ...
  <div class="row">
    <div class="col-sm-3"><button type="button" class="btn btn-success"><a href="mech-orders.php">My Orders</a></button>
  </div>
    <div class="col-sm-3"><button type="button" class="btn btn-success"><a href="mech-page.php">My Profile</a></button>
  </div>
